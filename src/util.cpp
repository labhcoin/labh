...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\LABH
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\LABH
    // Mac: ~/Library/Application Support/LABH
    // Unix: ~/.labh
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "LABH";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "labh.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "labhd.pid"));
