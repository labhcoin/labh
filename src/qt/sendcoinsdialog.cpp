    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a LABH address (e.g. La4m6GeapRXnGioBEzer2xSXr4DwpM2xQi)"));
...
void SendCoinsDialog::setBalance(CAmount balance, CAmount stake, CAmount unconfirmedBalance, CAmount immatureBalance)
{
    Q_UNUSED(stake);
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid LABH address"));
        }
        else
        {
