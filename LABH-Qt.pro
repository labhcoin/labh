...
isEmpty(OPENSSL_INCLUDE_PATH) {
    macx:OPENSSL_INCLUDE_PATH = /usr/local/Cellar/openssl/1.0.2o_1/include
}

isEmpty(OPENSSL_LIB_PATH) {
    macx:OPENSSL_LIB_PATH = /usr/local/Cellar/openssl/1.0.2o_1/lib
}
...
macx:ICON = src/qt/res/icons/LABH.icns
macx:TARGET = "LABH-Qt"
